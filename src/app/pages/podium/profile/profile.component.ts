...
import {EditProfileFormComponent} from "../../../features/shared/edit-profile/ui/edit-profile-form.component";
import {ManageUserAccessActionsComponent} from "../../../features/podium/manage-user-access/ui/manage-user-access-actions.component";
...
export class ProfileComponent implements OnInit, OnDestroy {
  ...
  loadAllData() {
    ...
    if (this.isAdmin() && profId !== undefined) {
      ...
      if (profId !== undefined) {
        this.router.navigate(['/podium/profile']);
      } else {
